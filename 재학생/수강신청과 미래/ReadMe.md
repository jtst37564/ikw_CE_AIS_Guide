...
임베디드를 하고 싶으시다고요? 그러면 2학년 때 배우는 VHDL이랑 디지털논리회로랑 컴퓨터시스템구조는 꼭 하십쇼. 4학년 때 배우는 VHDL 설계과목도 꼭 배우십쇼.
...
어딜가나 Out Law는 존재합니다. 굳이 미래를 위해서 착실하게 따박따박 과목 들을 필요는 없죠.
...
보너스로 과목 종류를 추천해드리자면 역시 교양보다는 전공을 더 추천하는 바입니다.
...
(교양은 신경 안 써도 됩니다. 그냥 교양학점으로만 인정 받을 수 있으면 그만이거든요. 그래도 정 불안하다면 문의해보시길 바랍니다.)
