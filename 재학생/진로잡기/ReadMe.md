...
**개발을 하고 싶다고요? 그러면 과감하게 교수님에게 게임업체 가겠다고 이야기한 뒤에 스스로 지원서 작성해서 스스로 개발업체에 들어가면 됩니다.**
...
어떻게 보면 SI기업과 비슷한 부분이 많이 보입니다만, SI는 그래도 개발이라도 하니 개발직스럽게 보이는데, 유지보수는 그냥 그 자체가 유지보수라서 뭐라 해줄 말이 없습니다.
